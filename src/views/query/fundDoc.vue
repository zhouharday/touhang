    ...
    <el-row :gutter="24">
        ...
        <!--<el-col :span="20" class="addPadding">-->
            ...
            <!--<el-table :data="reportData" border style="width: 100%" :show-header="false">-->
                <!--<el-table-column prop="doc" label="基金名称">-->
                <!--</el-table-column>-->
            ...
            <!--</el-table>-->
            <!--&lt;!&ndash; 基金设立文件 &ndash;&gt;-->
            <!--<tableHeader :data="projectTitle"></tableHeader>-->
            <!--<el-table :data="reportData" border style="width: 100%" :show-header="false">-->
                <!--<el-table-column prop="doc" label="基金名称">-->
                <!--</el-table-column>-->
                <!--<el-table-column prop="name" label="审核人">-->
            ...
            <!--</el-table>-->
            <!--&lt;!&ndash; 管理报告 &ndash;&gt;-->
            <!--<tableHeader :data="manageTitle"></tableHeader>-->
            <!--<el-table :data="reportData" border style="width: 100%" :show-header="false">-->
                <!--<el-table-column prop="doc" label="基金名称">-->
                <!--</el-table-column>-->
                <!--<el-table-column prop="name" label="审核人">-->
...
export default {
    ...
    methods: {
        listClick(menu) {
            console.log(menu)
            getFundRightList(menu.id).then((res) => {
                console.log(res.data)

            })
        },
        handleIconClick(){
            getFundLeftList(this.inputSearch).then((res) => {
                console.log(res.data)
