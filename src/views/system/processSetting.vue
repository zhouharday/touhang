            ...
            <el-tab-pane label="审批配置" name="fourth">
                <div class="approvalConfigure">
                    ...
                    <div v-show="s_show">
                        ...
                        <div
                            style="margin:10px 0 20px 0;padding-bottom:2px;border-bottom:1px solid #f05e5e;font-size:16px;font-weight:bold">
                            XXXXX流程模型
                        </div>
                        <div v-for="(item,index) in processNodes" :key="item.index"
                             style="display:flex;flex-wrap:nowrap">
                            <div
                                style="width:300px;height:150px;border: 1px solid #f05e5e;border-radius:5px;padding:15px;margin: 0 20px 20px 0">
                                <p>{{item.nodeName}}</p>
                                <p></p>
                                <p></p>
                            </div>
