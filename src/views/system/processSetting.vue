        ...
        <el-tabs v-model="activeName" @tab-click="handleClick">
            ...
            <el-tab-pane label="审批配置" name="fourth">
                <div class="approvalConfigure">
                    ...
                    <div v-show="s_show" class="showNode">
                        ...
                        <div style="display:flex;overflow-x:auto;">
                            <div v-for="(item,index) in processNodes" :key="item.index" style="flex:none;width:350px;height:200px;border: 1px solid #f05e5e;border-radius:5px;padding: 25px 15px;margin: 0 60px 20px 0">
                                <p>{{item.nodeName}}</p>
                                <p style="margin-top:25px">
                                    <el-radio class="radio" v-model="item.checkRadio" label="1">
                                        人员：
                                        <el-select v-model="item.member" filterable placeholder="请选择" style="height:15px">
                                ...
                                <p style="margin-top:25px">
                                    <el-radio class="radio" v-model="item.checkRadio" label="2">
                                        角色：
                                        <el-select v-model="item.role" filterable placeholder="请选择">
