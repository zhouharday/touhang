                ...
                <div v-for="item in leftList">
                    <div class="project_config">
                        ...
                        <div class="project_config">
                            ...
                            <div class="menu_box">
                                ...
                                <el-input v-model="item.stageName"></el-input>
                                    ...
                                    <el-button v-if="!item.editFlag" type="text" class="leftBtn"
                                               @click="edit(index,item)">编辑
                                    </el-button>
                                    <el-button v-if="item.editFlag" type="text" class="leftBtn"
                                               @click="edit(index,item)">保存
                                    </el-button>
                        ...
                        <div class="project_config">
                            <div class="menu_title">
                                <div style="justify-content: space-between;flex-direction: row;display: flex">
                                    ...
                                    <div v-if="!item.showOne" style="color: red; padding-right: 20px">
                                        <el-button type="text" class="leftBtn" @click="changeSomeThing(item)">操作
                                        </el-button>
                                    </div>
                                    <div v-if="item.showOne" style="color: red; padding-right: 20px">
                                        <el-button type="text" class="leftBtn" @click="openProject">添加</el-button>
                                        <el-button type="text" class="leftBtn" @click="changeSomeThing(item)">完成
                                        </el-button>
                                    </div>
                                </div>
                            ...
                            <div class="menu_box">
                                <div class="menu_list" v-for="(detailsitem,index) in item.data" :key="detailsitem.index"
                                     @click="refreshList(detailsitem)">
                                    <div style="height: 35px ;width: 100px;overflow: hidden">
                                        <span v-if="!detailsitem.editFlag"
                                              style="line-height: 35px;width: 100px;width: 200px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;">{{detailsitem.stageName}}</span>
                                ...
                                <el-input v-model="detailsitem.stageName" style="width: 100px"></el-input>
                                    ...
                                    <div v-if="detailsitem.stageStatus == 1">
                                        <div v-if="item.showOne" style="justify-content: space-between">
                                            ...
                                            <el-button v-if="!detailsitem.editFlag" type="text" class="leftBtn"
                                                       @click="edit(index,detailsitem)">编辑
                                            </el-button>
                                            <el-button v-if="detailsitem.editFlag" type="text" class="leftBtn"
                                                       @click="edit(index,detailsitem)">确定
                                            </el-button>
                                            <el-button type="text" @click="handleDeleteLeft(index,item.data)">删除
                                            </el-button>
                                        </div>
                                    </div>
                        ...
                        <el-table :data="fileData" style="width: 100%">
                            ...
                            <el-table-column label="操作" align="center">
                                <template scope="scope">
                                    ...
                                    <el-button type="text" size="small" @click="handleDelete(scope.$index,fileData)">
                                        删除
                                    </el-button>
                                </template>
                            </el-table-column>
...
//                console.log (item)
            ...
            addProject() {
                var a = [{
                    "stageName": this.projectForm.stageName,
                    "stageType": this.changeList[0].stageType,
                    "merchantId": this.changeList[0].merchantId
                }];
