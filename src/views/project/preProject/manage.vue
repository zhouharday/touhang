                            ...
                            <el-row>
                                ...
                                <el-col :span="12">
                                    <el-form-item label="经办人">
                                        <el-input v-model="contractForm1.handlerUserId" placeholder="默认当前登录用户" auto-complete="off" disabled></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="12">
                    ...
                    <el-dialog title="编辑项目合同" :visible.sync="contractAdd2" :close-on-click-modal="false">
                        <el-form :model="contractForm2" label-width="110px">
                            <el-row>
                                ...
                                <el-col :span="12">
                                    <el-form-item label="经办人">
                                        <el-input v-model="contractForm2.handlerUserId" placeholder="默认当前登录用户" auto-complete="off" disabled></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="12">
                                    <el-form-item label="经办日期">
                    ...
                    <el-dialog title="添加投资支付" :visible.sync="paidAdd1" :close-on-click-modal="false" style="width：65%;">
                        <el-form :model="paidForm1" label-width="110px">
                            <el-row>
                                ...
                                <el-col :span="12">
                                    <el-form-item label="经办人">
                                        <el-input v-model="paidForm1.handlerUserId" placeholder="默认当前登录用户" auto-complete="off" disabled></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="12">
                    ...
                    <el-dialog title="添加项目分红" :visible.sync="sharingAdd1" :close-on-click-modal="false">
                        <el-form :model="sharingForm1" label-width="110px">
                            <el-row>
                                ...
                                <el-col :span="12">
                                    <el-form-item label="经办人">
                                        <el-input v-model="sharingForm1.handlerUserId" placeholder="默认当前登录用户" auto-complete="off" disabled></el-input>
                                    </el-form-item>
                                </el-col>
                                <el-col :span="12">
