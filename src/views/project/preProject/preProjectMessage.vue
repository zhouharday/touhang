    ...
    <div class="preProjectMessage">
        ...
        <el-row class="step">
            ...
            <el-col :span="4" class="step_second step_span"
                    :class="{'step_span_change step_second_change':second_step}">
            ...
            <el-col :span="4" class="step_second step_span"
                    :class="{'step_span_change step_second_change':fourth_step}">
                <span>{{step_fourth}}</span>
            </el-col>
            <el-col :span="4" class="step_second step_span"
                    :class="{'step_span_change step_second_change':fiveth_step}">
        ...
        <!-- 中止确认弹框 -->
        <delete-reminders :deleteReminders="deleteReminders" :modal_loading="modal_loading"
                          :message_title="message_title" :message="message" :btnText="btnText" @del="jumpPool"
                          @cancel="deleteReminders=false">
        </delete-reminders>
        <!-- 发起申请 对话框-->
        ...
        <div class="progressBox">
            <el-dialog title="查看进度" :visible.sync="progressModal" :close-on-click-modal="false">
                ...
                <div>
                    ...
                    <el-form :model="applyForm2" ref="applyForm" style="margin-top:20px" label-width="100px">
                        <el-row>
                            <el-col>
                                <el-form-item label="标题" prop="name">
                                    <el-input v-model="applyForm2.title" placeholder="数据展示" auto-complete="off"
                                              disabled></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="申请人" prop="person">
                                    <el-input v-model="applyForm2.person" placeholder="数据展示" auto-complete="off"
                                              disabled></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="12">
                                <el-form-item label="申请日期" prop="date">
                                    <el-input v-model="applyForm2.date" placeholder="数据展示" auto-complete="off"
                                              disabled></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col>
                                <el-form-item label="备注" prop="notes">
                                    <el-input type="textarea" :rows="2" v-model="applyForm2.notes" placeholder="数据展示"
                            ...
                            <el-col :span="8">
                                <el-form-item label="考察报告" prop="reports" style="margin-bottom:10px">
                                    <el-input v-model="applyForm2.reports" placeholder="数据展示" auto-complete="off"
                                              disabled>
                                    </el-input>
                                </el-form-item>
                            </el-col>
                ...
                <div>
                    ...
                    <div class="comment_box" :class="{bgh: (index%2 == 0),bgl: (index%2 != 0)}"
                         v-for="(item,index) in commentLists" :key="item.index">
