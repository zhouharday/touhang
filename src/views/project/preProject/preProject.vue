    ...
    <div class="preContent">
        ...
        <el-row class="common">
            ...
            <el-col :span="22" style="margin-top:20px">
                <div class="state-ul">
                    <ul ref="state">
                        <li v-for="(item,index) in stageList" :key="item.index" :class="{active: index==currentIndex1}"
        ...
        <el-row class="common">
            ...
            <el-col :span="22">
                <div class="sort-ul">
                    <ul ref="sort">
                        <li v-for="(item,index) in sortList" :key="item.index" :class="{active: index==currentIndex2}"
                ...
                <el-table :data="tableData" style="width:100%" max-height="700" class="table-item"
                    ...
                    <el-table-column label="项目名称" align="center">
                        <template scope="scope">
                            <a class="project" @click="ShowPreMessage(scope.row,scope.$index)">{{ scope.row.project
                                }}</a>
                        </template>
                    </el-table-column>
