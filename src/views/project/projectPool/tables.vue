    ...
    methods: {
        ...
        confirmAdd3() {
            ...
            this.structureData.push({
                name: this.structureForm1.name,
                property: this.structureForm1.property,
                capital: this.structureForm1.capital,
                num: this.structureForm1.num,
                percent: this.structureForm1.percent
            });
            this.clearSVal1();
        },
        //编辑 股权结构的方法
        ...
        clearMVal1() {
            ...
            this.memberForm1.phone = ''
        },
        //清除 编辑董事会成员对话框
        clearMVal2() {
            this.memberForm2.name = '';
            this.memberForm2.property = '';
            this.memberForm2.edu = '',
            this.memberForm2.phone = ''
        },
        //清除 添加股权结构对话框
        clearSVal1() {
            this.structureForm1.name = '';
            this.structureForm1.property = '';
            this.structureForm1.capital = '',
            this.structureForm1.num = '',
            this.structureForm1.percent = ''
        },
        //清除 编辑股权结构对话框
        clearSVal2() {
            this.structureForm2.name = '';
            this.structureForm2.property = '';
            this.structureForm2.capital = '',
            this.structureForm2.num = '',
            this.structureForm2.percent = ''
        }
    },
    components: {
        tabelHeader
